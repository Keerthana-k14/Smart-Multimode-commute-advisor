    ...
    <div className="app">
      ...
      <main className="layout">
        ...
        <aside className="panel-left">
          ...
          {/* Static model info always visible */}
          <div className="model-chip-group">
            <div className="model-chip">
              <span className="chip-label">Model</span>
              <span className="chip-value">Random Forest</span>
            </div>
            <div className="model-chip">
              <span className="chip-label">Dataset</span>
              <span className="chip-value">8,936 records</span>
            </div>
            <div className="model-chip">
              <span className="chip-label">Features</span>
              <span className="chip-value">6 engineered</span>
            </div>
            <div className="model-chip">
              <span className="chip-label">Best MAE</span>
              <span className="chip-value">1.34 min</span>
            </div>
          </div>
        </aside>
